...
public extension AsyncType {
    public func debug(_ identifier: String? = nil, logger: LoggerType = Logger(), file: String = #file, line: UInt = #line, function: String = #function, context c: ExecutionContext = .defaultContext) -> Self {
