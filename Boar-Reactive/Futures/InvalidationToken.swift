...
extension InvalidationTokenType {
    ...
    public func validContext(_ parentContext: ExecutionContext = .defaultContext) -> ExecutionContext {
...
public class InvalidationToken : ManualInvalidationTokenType {
    ...
    public let future = Future<NoValue>()
    ...
    public func invalidate() {
        future.failure(BrightFuturesError.invalidationTokenInvalidated)
    }
}
